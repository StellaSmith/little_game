...
namespace engine {
    ...
    engine::result<engine::File, std::errc> create_cache_file(std::string_view name);
     ...
     */
    engine::result<engine::File, std::errc> get_cache_file(std::string_view name, std::span<std::filesystem::path const> ref_files = {});
} // namespace engine
